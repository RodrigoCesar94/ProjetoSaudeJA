...
public class Paciente implements InterfacePaciente { // implementação dos métodos presentes na interface.
    // declaração de variáveis
	private String nome;
	private int   idade;
	Scanner resposta = new Scanner(System.in); // Criação do Scanner, para leitura do Console.d
	
	// criação de getters and setter, encapsulamento.
